...
from games.barca.players.minimax_alt_player import MinimaxBarcaPlayerOther
...
def main():
    ...
    run_simulation("Maquina vs C.A.V.A.S", BarcaSimulator(MinimaxBarcaPlayerOther("C.A.V.A.S"), MinimaxBarcaPlayerOther("Minimax Alternativo")), num_iterations)
    run_simulation("Maquina vs C.A.V.A.S", BarcaSimulator(HumanPlayer("C.A.V.A.S"), HumanPlayer("Take It Easy")), num_iterations)
    run_simulation("Maquina vs C.A.V.A.S", BarcaSimulator(HumanPlayer("C.A.V.A.S"), MinimaxBarcaPlayerOther("Minimax Alternativo")), num_iterations)
